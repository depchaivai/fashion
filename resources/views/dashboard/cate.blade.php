<x-dashboard.adminlayout>
    ...
    <div class="w-full p-4">
        <span class="px-2 py-1 font-bold text-2xl block">quản lý danh mục</span>
        <span class="px-2 py-1 italic text-gray-400">thêm danh mục tại đây</span><button id="addCateBtn" class="rounded-full bg-green-400 text-white w-7 h-7 text-center leading-7"><i class="fa-solid fa-plus"></i></button>
        <x-dashboard.catepopup :allcate="$all_cate"/>
        <div class="mt-5">
            <span class="font-bold text-xl px-2 py-1 text-blue-500">danh mục hiện có</span>
            <ul class="">
