<x-dashboard.adminlayout>
    <x-slot name="myjs">
        <script>
            ...
            callEditTrademarkBtn.addEventListener('click',(e)=>{
                ...
                $.ajax({
                            url: "/dashboard/callajax/updateth/"+idth,
                            type:"PUT",
                            data:{
                                name:thname,
                                cate:thcate,
    ...
    <div class="w-full p-4">
        <span class="px-2 py-1 font-bold text-2xl block">quản lý thương hiệu</span>
        ...
        <div class="mt-5">
            <span class="font-bold text-xl px-2 py-1 text-blue-500">thương hiệu hiện có</span>
            <ul class="">
